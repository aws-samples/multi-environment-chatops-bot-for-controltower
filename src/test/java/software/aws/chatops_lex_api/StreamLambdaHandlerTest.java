...
import software.aws.chatops_lex_api.StreamLambdaHandler;
...
public class StreamLambdaHandlerTest {
    ...
    public void ping_streamRequest_respondsWithHello() {
        InputStream requestStream = new AwsProxyRequestBuilder("/account", HttpMethod.POST)
                                            .header(HttpHeaders.ACCEPT, MediaType.APPLICATION_JSON)
                                            .body("{\"UserEmail\": \"lddecaro@amazon.com\",\"UserName\": \"Luiz\", \"UserLastname\": \"Decaro\",  \"UserInput\": \"Hi I want to create a new account\"}")
                                            .buildStream();
